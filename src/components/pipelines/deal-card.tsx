...
export function DealCard({ deal, stage, onEdit, isOverlay }: DealCardProps) {
  ...
  return (
    ...
    <button
      ...
      className={`group relative flex w-full cursor-pointer flex-col gap-1.5 rounded-xl border border-border/60 bg-card p-2.5 text-left shadow-sm transition-all ${
        isOverlay
          ? "rotate-2 shadow-xl"
